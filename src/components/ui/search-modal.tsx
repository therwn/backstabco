    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[999999999] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-black-600">
          <h2 className="text-xl font-semibold text-white">Item Arama</h2>
          <button
            onClick={onClose}
              ...
              {items.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-medium">{formatItemName(item)}</div>
                    <div className="text-sm opacity-70">{item.category} • {item.subcategory}</div>
                  </div>
                </div>
              ))}
            </div>
